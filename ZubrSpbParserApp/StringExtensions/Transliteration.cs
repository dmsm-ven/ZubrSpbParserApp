...
namespace ZubrSpbParserApp.StringExtensions
{
    ...
    public static class Transliteration
    {
        ...
        public static string Front(string text, bool toLower)
        {
            return Front(text, TransliterationType.ISO, toLower);
        }
        public static string Front(string text, TransliterationType type, bool toLower)
        {
            string output = text;
            ...
            return toLower ? output.ToLower() : output;
        }
